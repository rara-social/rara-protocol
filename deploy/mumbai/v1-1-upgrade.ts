...
// Run: npx hardhat deploy --network mumbai --tags mumbai-upgrade-v1-1 --export-all ./deploy_v2/hardhat_contracts.json
module.exports = async (hre: HardhatRuntimeEnvironment) => {
  ...
  const curatorToken1155Address = "0xb3046DD943D6F0c5b3EB124595a5AeB1a180d46a";
  let addressManagerAddress = "0x66C3752f87A867De5747ac49ED54326Db3Ca8604";
  // console.log({
  //   roleManagerAddress,
  ...
  // reaction price
  await parameterManager.setFreeReactionLimit(config.reactionPrice, {
    gasLimit: "200000",
  });
